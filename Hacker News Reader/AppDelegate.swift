...
//  Hacker News Reader
//
//  Created by Josh Lapham on 25/07/2015.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.NerdBurgerLabs.Hacker_News_Reader" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Hacker_News_Reader", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: NSBundle.mainBundle().bundleIdentifier!, code: 9999, userInfo: dict)
